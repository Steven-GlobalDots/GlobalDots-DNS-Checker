...
function App() {
  ...
  const handleCompare = () => {
    console.log("Comparing...", { sourceFile, destinationType, destinationFile, destinationServer })
  }
      ...
      <main className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <div className="flex justify-end pt-4">
          <button
            ...
            disabled={!sourceFile || (destinationType === 'file' ? !destinationFile : !destinationServer)}
